        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-black/95 backdrop-blur-sm py-6 px-4 mt-2 shadow-lg">
            <div className="flex flex-col space-y-4">
              <Link href="/categories/women" className="text-white hover:text-tan py-2">Women</Link>
              <Link href="/categories/men" className="text-white hover:text-tan py-2">Men</Link>
